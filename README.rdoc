...
* MySql (trinidad-mysql-dbpool-extension)

== Usage

* Install the extension gem, ie: trinidad-mysql-dbpool-extension
...
While _jndi_, _username_, _password_ and _url_ are mandatory, other

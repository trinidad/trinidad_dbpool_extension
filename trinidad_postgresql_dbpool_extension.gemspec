...
Gem::Specification.new do |s|
  s.name = %q{trinidad_postgresql_dbpool_extension}
  s.version = "0.1.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["David Calavera"]
  s.date = %q{2010-05-05}
  s.description = %q{Addon to support PostgreSQL database pools in Trinidad}
  ...
  s.summary = %q{Addon to support PostgreSQL database pools in Trinidad}
  s.test_files = [
    "spec/spec_helper.rb",
